...
import { MovimentationCategory, PaymentCardType } from "lib/enums";
...
const translatePaymentCardType = (type: string) => {
  switch (type) {
  case PaymentCardType.DEBIT:
    return "Débito";
...
const formatPaymentCardNumber = (cardNumber: string) => {
  return cardNumber.substring(0, 4) + " **** **** " + cardNumber.substring(cardNumber.length - 5, cardNumber.length - 1);
};
