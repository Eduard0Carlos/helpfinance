package com.helpfinance.infrastructure.dao.base;

import com.helpfinance.infrastructure.interfaces.base.IBaseDAO;
...
public abstract class baseEntityDAO<TEntity extends EntityBase> implements IBaseDAO<TEntity> {
    ...
    public Boolean delete(TEntity entity) {
        ...
        try {
            var statement = connection.prepareStatement("DELETE FROM " + _tableName + " WHERE id = " + fieldUtils.formatUuidToString(entity.getId()));
    ...
    public Boolean delete(UUID id) {
        ...
        try {
            var statement = connection.prepareStatement("DELETE FROM " + _tableName + " WHERE id = " + fieldUtils.formatUuidToString(id));
